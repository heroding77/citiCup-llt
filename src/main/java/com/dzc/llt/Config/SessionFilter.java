...
public class SessionFilter implements Filter {
    ...
    String[] includeUrls = new String[]{"/login","/","/register","/login_data","/android/login_data","/android/verification_code","/verification_code","/android/register_data","注册.html","/mailService"};
